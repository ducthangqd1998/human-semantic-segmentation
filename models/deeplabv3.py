...
import torchvision.models as model_1
...
class DeepLabV3Plus(BaseModel):
    def __init__(self, backbone='resnet18', output_stride=16, num_classes=2, freeze_bn=False, pretrained_backbone=None):
        ...
        self.backbone = model_1.resnet18()
